...
price: '<span class="money" data-line-index="' + index +  '">' + theme.Currency.formatMoney(product.price, theme.settings.moneyFormat) + '</span>',
...
totalPrice: '<span class"money" data-cart-total>' + theme.Currency.formatMoney(cart.total_price, theme.settings.moneyFormat) + '</span>'
};
  ...
  theme.RecentlyViewed = (function() {
    ...
    (typeof window.BOLD !== 'undefined' && typeof window.BOLD.pre !== 'undefined' && typeof BOLD.pre.addProductJson !== 'undefined' && BOLD.pre.addProductJson({id: product.id, variants: product.variants }));
// Ignore current product
          ...
          product.sold_out = !product.available;product.price_formatted = '<span class="money" data-product-id="' + product.id + '">' + theme.Currency.formatMoney(product.price, theme.settings.moneyFormat) + '</span>';product.compare_at_price_formatted = theme.Currency.formatMoney(product.compare_at_price, theme.settings.moneyFormat);
  ...
  theme.Product = (function() {
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      updatePrice: function(evt) {
        ...
        if (variant) {
          // Regular price
$(this.selectors.price).html('<span class="money" data-variant-id="' + variant.id + '">' + theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat) + '</span>').show();
